...
CREATE TABLE `product` (
  ...
  KEY `fk_manufacture_idx` (`ProductManufacturer`),
  KEY `fk_category_idx` (`ProductCategory`),
  CONSTRAINT `fk_category` FOREIGN KEY (`ProductCategory`) REFERENCES `category` (`id_category`),
  CONSTRAINT `fk_manufacture` FOREIGN KEY (`ProductManufacturer`) REFERENCES `manufacturers` (`id_manufacturers`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-28  7:11:45
